...
({									\
	...
	case __X86_CASE_B:						\
	{								\
		volatile uint8_t *__ptr = (volatile u8 *)(ptr);		\
	...
	case __X86_CASE_W:						\
	{								\
		volatile uint16_t *__ptr = (volatile u16 *)(ptr);		\
	...
	case __X86_CASE_L:						\
	{								\
		volatile uint32_t *__ptr = (volatile u32 *)(ptr);		\
	...
	case __X86_CASE_Q:						\
	{								\
		volatile uint64_t *__ptr = (volatile u64 *)(ptr);		\
...
({									\
	...
	case __X86_CASE_B:						\
	{								\
		volatile uint8_t *__ptr = (volatile u8 *)(_ptr);		\
	...
	case __X86_CASE_W:						\
	{								\
		volatile uint16_t *__ptr = (volatile u16 *)(_ptr);		\
	...
	case __X86_CASE_L:						\
	{								\
		volatile uint32_t *__ptr = (volatile u32 *)(_ptr);		\
	...
	case __X86_CASE_Q:						\
	{								\
		volatile uint64_t *__ptr = (volatile u64 *)(_ptr);		\
